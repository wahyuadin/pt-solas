<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <ul class="menu-inner py-1">
      ...
      <li class="menu-item @yield('menu')">
        ...
        <ul class="menu-sub">
          <li class="menu-item @yield('buku')">
            <a href="{{ route('databuku.admin') }}" class="menu-link">
              <div data-i18n="Without menu">Data Buku</div>
            </a>
          </li>
          <li class="menu-item @yield('kategori')">
            <a href="{{ route('kategoribuku.admin') }}" class="menu-link">
      ...
      <li class="menu-item @yield('peminjaman')">
        <a href="{{ route('peminjamanbuku.admin') }}" class="menu-link">
      ...
      <li class="menu-item @yield('datauser')">
        <a href="{{ route('datauser.admin') }}" class="menu-link">
          <i class="menu-icon tf-icons bx bxs-user"></i>
          <div data-i18n="Boxicons">Data User</div>
        </a>
      </li>
      @endif
      ...
      <li class="menu-item @yield('buku')">
        <a href="{{ route('databuku.user') }}" class="menu-link">
          <i class="menu-icon tf-icons bx bxs-book-open"></i>
          <div data-i18n="Boxicons">List Buku</div>
        </a>
      </li>
      <li class="menu-item @yield('peminjaman')">
        <a href="{{ route('peminjamanbuku.user') }}" class="menu-link">
          <i class="menu-icon tf-icons bx bx-book-add"></i>
          <div data-i18n="Boxicons">Data Peminjam</div>
        </a>
      </li>
