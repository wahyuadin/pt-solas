          ...
          <div class="col-12 mb-4">
            <div class="card">
              <div class="card-body">
                ...
                <span class="d-block mb-1">Data Peminjam</span>
                @php
                    $pinjam = \App\Models\Pinjam::where('user_id', Auth::user()->id)->count();
                @endphp
                <h3 class="card-title text-nowrap mb-2">{{ $pinjam }} Buku</h3>
              </div>
            </div>
          </div>
          <div class="col-12 mb-4">
